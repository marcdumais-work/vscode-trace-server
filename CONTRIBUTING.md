...
Thanks for your interest in the [Trace Server VS Code extension][vscode-ext]!. The following is a set of
guidelines for contributing to the Trace Server extension for `VS Code` compatible tools. Information
about the trace viewer capabilities can be found in the [Trace Viewer extension][trace-viewer]
repository and its [issue trackers][trace-issues].
...
For issues related to this extension, please open a GitHub tracker for the [VS Code Trace Server Extension][vscode-ext] repository.
...
[issues]: https://github.com/eclipse-cdt-cloud/vscode-trace-server/issues
...
[pull-requests]: https://github.com/eclipse-cdt-cloud/vscode-trace-server/pulls
[sign-off]: https://git-scm.com/docs/git-commit#Documentation/git-commit.txt---signoff
[trace-issues]: https://github.com/eclipse-cdt-cloud/vscode-trace-extension/issues
[trace-viewer]: https://github.com/eclipse-cdt-cloud/vscode-trace-extension
[vscode-ext]: https://github.com/eclipse-cdt-cloud/vscode-trace-server
